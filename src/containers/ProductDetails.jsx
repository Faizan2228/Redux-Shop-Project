...
export const ProductDetails = () => {
  ...
  const {image, id, description, category, price, title} = product

  const {productId} = useParams()
  const dispatch = useDispatch()

  const fetchProduct = async () => {
    const response = await axios.get(`https://fakestoreapi.com/products/${productId}`).catch((error) => console.log("err:",error))
